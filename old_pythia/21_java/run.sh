...
javac -cp ".:input/lib/pythia.jar" Q2.java 2> output/q2.err
java -cp ".:input/lib/opencsv-2.3.jar:input/lib/pythia.jar" Q2 1> output/q2.out 2> output/q2.err
