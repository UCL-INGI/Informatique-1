...
if os.path.exists(resultpath):
    with open(resultpath, 'r', encoding = 'utf-8') as file:
        ...
        with open('feedback.xml', 'w', encoding = 'utf-8') as feedbackfile:
            feedbackfile.write('<feedback><question id="q1" verdict="OK"><![CDATA[<p>Votre classe Employe semble fonctionner correctement.</p>]]></question><verdict>OK</verdict></feedback>')